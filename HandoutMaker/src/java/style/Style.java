...
{
	//fï¿½g Variablen hinzu, wenn dir welche einfallen, hab bestimmt net alle, hau die dann auch unten in den constructor
	public short size, format; //format = Blocksatz, zentriert etc., mir fiel kein besserer Name ein, datentyp muss vllt gewechselt werden, fï¿½rs erste: 0=rechts, 1 = mitte, 2 = links, 3 = block
